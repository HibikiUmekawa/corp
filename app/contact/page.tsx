...
export default function ContactPage() {
  ...
  return (
    <>
      <NextSeo
        title="お問い合わせ | TS Prime株式会社"
        description="TS Prime株式会社へのお問い合わせはこちらのフォームから受け付けております。採用・業務提携・取材などもお気軽にご連絡ください。"
        canonical="https://example.com/contact"
        openGraph={{
          url: "https://example.com/contact",
          title: "お問い合わせ | TS Prime株式会社",
          description:
            "TS Prime株式会社へのお問い合わせはこちらのフォームから受け付けております。",
          images: [
            {
